      ...
      >
        <div className="container mx-auto px-6">
          ...
          <motion.p 
            ...
            variants={itemVariants}
          >
            We build custom, scalable, and intelligent solutions that empower
            your business to innovate and lead in the digital age.
          </motion.p>
          <motion.div 
      ...
      <section id="features" className="relative z-10 py-20">
        <div className="container mx-auto px-6">
          <motion.div className="text-center mb-16" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.5 }} transition={{ duration: 0.5 }}>
            <h2 className="text-3xl md:text-4xl font-bold text-white">Why SmartNex.ai?</h2>
            <p className="mt-4 text-lg md:text-xl text-neutral-300">Driving tangible results through innovation and expertise.</p>
          </motion.div>
          <motion.div className="grid grid-cols-1 md:grid-cols-3 gap-8" initial="hidden" whileInView="visible" variants={containerVariants} viewport={{ once: true, amount: 0.2 }}>
            {[ { icon: <BrainCircuitIcon />, title: "Custom Solutions", description: "Tailor-made AI models that fit your unique business challenges and strategic goals." }, { icon: <ScalingIcon />, title: "Scalable Infrastructure", description: "Robust and efficient systems designed to grow with your data and operational demand." }, { icon: <ExpertTeamIcon />, title: "Expert Team", description: "Access to leading AI researchers and engineers dedicated to ensuring your project's success." } ].map((feature, i) => (
      ...
      <section id="process" className="relative z-10 py-20">
        <div className="container mx-auto px-6">
          <motion.div className="text-center mb-16" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.5 }} transition={{ duration: 0.5 }}>
            ...
            <p className="mt-4 text-lg md:text-xl text-neutral-300">A structured approach to guarantee success and alignment.</p>
          </motion.div>
          <div className="relative">
            ...
            <motion.div className="grid grid-cols-1 md:grid-cols-3 gap-12" initial="hidden" whileInView="visible" variants={containerVariants} viewport={{ once: true, amount: 0.2 }}>
              {[ { title: "1. Discovery & Strategy", description: "We dive deep into your business to understand your objectives and define a clear AI strategy." }, { title: "2. Development & Integration", description: "Our team builds your custom AI models and seamlessly integrates them into your existing workflow." }, { title: "3. Deployment & Optimization", description: "We deploy the solution and continuously monitor performance, optimizing for peak efficiency and impact." } ].map((step, i) => (
